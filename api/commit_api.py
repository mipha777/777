...
def get_hot_commit(cookie,params_key,encSecKey,params,songid,ua):
    headers = {
        'accept': '*/*',
        ...
        'priority': 'u=1, i',
        'referer': f'https://music.163.com/song?id={songid}',
    ...
    # headers =
    commit_url = 'https://music.163.com/weapi/comment/resource/comments/get?'
    respond = requests.post(commit_url,headers=headers,cookies=cookie,data=data,params=params)
